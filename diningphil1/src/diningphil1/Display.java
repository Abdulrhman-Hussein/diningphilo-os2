...
public class Display extends JPanel implements Runnable {
 ...
 public Display(){
  ...
  bg=t.getImage("image//WhatsApp Image 2022-12-17 at 01.20.41.jpg");
  s0=t.getImage("image//14_2_600x400.png");
  s1=t.getImage("image//14_2_600x400.png");
  s2=t.getImage("image//14_2_600x400.png");
  s3=t.getImage("image//14_2_600x400.png");
  s4=t.getImage("image//14_2_600x400.png");
  state1=t.getImage("image//kisspng-hamburger-eating-fast-food-junk-food-clip-art-eating-png-picture-5a74a4e2702fc1.7095608615175938264595.jpg");
  state2=t.getImage("image//vecteezy_confused-man-with-question-mark-concept-flat-illustration_.jpg");
